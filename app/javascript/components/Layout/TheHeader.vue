<template>
  <v-container>
    ...
    <v-navigation-drawer width=225 v-model="drawer" app dark style="background-color: #000000;">
            ...
            <v-list-item @click="changeRoute(item.path_name)" class="ml-1">
              <v-list-item-icon>
                <v-list-item-subtitle class="mt-1" :size="icon.size">
                  <icon-base v-if="item.text === 'ホーム'" :iconColor="'#c9d1d9'" icon-name="icon-home" :width="'17'"
                    :height="'17'" :viewBox="'0 0 512.05 512.05'">
                    <icon-home />
                  </icon-base>
                  <icon-base v-if="item.text === 'チャット'" :iconColor="'#c9d1d9'" icon-name="icon-following" :width="'17'"
                    :height="'17'" :viewBox="'0 0 511.996 511.996'">
                    <icon-following />
                  </icon-base>
                  <icon-base v-if="item.text === 'レビュー'" :iconColor="'#c9d1d9'" icon-name="icon-bookmark" :width="'17'"
                    :height="'17'" :viewBox="'0 0 512 512'">
                    <icon-bookmark />
                  </icon-base>
                  <icon-base v-if="item.text === 'コミュニティ'" :iconColor="'#c9d1d9'" icon-name="icon-bookmark"
                    :width="'17'" :height="'17'" :viewBox="'0 0 512 512'">
                    <icon-bookmark />
                  </icon-base>
                  <icon-base v-if="item.text === 'ランキング'" :iconColor="'#c9d1d9'" icon-name="icon-bookmark" :width="'17'"
                    :height="'17'" :viewBox="'0 0 512 512'">
                    <icon-bookmark />
                  </icon-base>
      ...
      <v-row justify="center" class="mt-n4">
        <v-col cols="12" sm="7" md="6" lg="11" class="ml-2">
          <v-chip-group column>
            <v-chip small outlined active-class="blue--text" class="mb-3 rounded-xl"
              style="width: auto; font-weight: bold;" @click="goTagPage(tag.attributes)" color="#c9d1d9" label
